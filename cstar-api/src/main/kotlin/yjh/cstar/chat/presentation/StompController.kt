...
class StompController(
    ...
    fun chatting(
        ...
        requireNotNull(playerId) { BaseException(ApiErrorCode.UNAUTHORIZED) }
        require(answerMessageRequest.answer.isNotBlank()) { BaseException(ApiErrorCode.EMPTY_ANSWER) }
        require(answerMessageRequest.quizId > 0) { BaseException(ApiErrorCode.INVALID_QUIZ_ID) }
